...
from env_local import AZURE_CLIENT_ID, AZURE_CLIENT_SECRET, AZURE_SUBSCRIPTION_ID, AZURE_TENANT_ID
...
credential = ServicePrincipalCredentials(client_id=AZURE_CLIENT_ID, secret=AZURE_CLIENT_SECRET, tenant=AZURE_TENANT_ID)
